...
- web: `init_module.dart.js` exposes a `flutter_soloud_ready` promise and the bindings await it before touching the module, fixing a startup crash when `SoLoud.init()` was called while the WASM module was still loading.
