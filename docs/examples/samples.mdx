...
The flutter_soloud package includes several example projects demonstrating various features. These examples can be found in the [example folder](https://github.com/alnitak/flutter_soloud/tree/main/example) of the package.
...
- `lib/metronome/metronome.dart` - Create a precise metronome using waveforms
...
### Audio Visualization
Learn how to display audio waveforms and data:
- Audio data visualization
- Sample reading and display
- Real-time waveform monitoring

### Audio Generation
Explore synthesizing audio:
- Waveform generation
- Frequency control
- Timing and synchronization

### Streaming
Understand audio streaming capabilities:
- PCM generation
- WebSocket streaming
- Buffer management
