...
typedef void (*dartFileLoadedCallback_t)(enum PlayerErrors *,
                                         char *completeFileName, unsigned int *,
                                         uint64_t *timeStamp);
...
void (*dartFileLoadedCallback)(enum PlayerErrors *, char *completeFileName,
                               unsigned int *, uint64_t *timeStamp) = nullptr;
...
void fileLoadedCallback(enum PlayerErrors error, char *completeFileName,
                        unsigned int *hash, uint64_t timeStamp) {
...
FFI_PLUGIN_EXPORT void loadFile(char *completeFileName, bool loadIntoMem,
  ...
  //                        {
  PlayerErrors error =
      p->loadFile(pa.string(), loadIntoMem, (unsigned int *)&hash);
