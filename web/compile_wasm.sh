...
# To help diagnose issues like segmentation faults, compile with debug information
# use the -g flag to include debugging symbols in the generated WASM file.
